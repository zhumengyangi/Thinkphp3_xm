                                ...
                                <div class="user_main_box">
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            <input class="TxtUserNameCssClass" id="admin_user" maxlength="20" name="admin_name"> </li></ul>
                                    <ul>
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input" >
                                            <input class="TxtValidateCodeCssClass" id="captcha" name="admin_captcha" type="text"><br/>
                                            <img src="<?php echo U('captcha');?>" 
                                            onclick='this.src="<?php echo U('captcha');?>#"+Math.random()'
                                              alt="" style='vertical-align:top;'/>
                                            <a href="#" 
                                            onclick="$(this).prev('img').trigger('click')"
                                            >看不清，换一张</a>
                                        </li>
                                    </ul>
                                </div>
